...
export class ContestOracleResolved__contestsResult {
  value0: BigInt;
  value1: BigInt;
  value2: Address;
  value3: Bytes;
  ...
  getScoreContestSourceHash(): Bytes {
    return this.value3;
  }
...
export class ContestOracleResolved__getContestResultValue0Struct extends ethereum.Tuple {
  get awayScore(): BigInt {
  ...
  get scoreContestSourceHash(): Bytes {
...
export class ContestOracleResolved extends ethereum.SmartContract {
  static bind(address: Address): ContestOracleResolved {
    return new ContestOracleResolved("ContestOracleResolved", address);
  }
  ...
  contests(param0: BigInt): ContestOracleResolved__contestsResult {
    let result = super.call(
      "contests",
      "contests(uint256):(uint32,uint32,address,bytes32,uint8,string,string,string)",
      [ethereum.Value.fromUnsignedBigInt(param0)],
    );

    return new ContestOracleResolved__contestsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toAddress(),
      result[3].toBytes(),
  ...
  try_contests(
    param0: BigInt,
  ): ethereum.CallResult<ContestOracleResolved__contestsResult> {
    let result = super.tryCall(
      "contests",
      "contests(uint256):(uint32,uint32,address,bytes32,uint8,string,string,string)",
      [ethereum.Value.fromUnsignedBigInt(param0)],
    ...
    return ethereum.CallResult.fromValue(
      new ContestOracleResolved__contestsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toAddress(),
        value[3].toBytes(),
  ...
  getContest(
    _contestId: BigInt,
  ): ContestOracleResolved__getContestResultValue0Struct {
    let result = super.call(
      "getContest",
      "getContest(uint256):((uint32,uint32,address,bytes32,uint8,string,string,string))",
      [ethereum.Value.fromUnsignedBigInt(_contestId)],
    );

    return changetype<ContestOracleResolved__getContestResultValue0Struct>(
      result[0].toTuple(),
    );
  }
  ...
  try_getContest(
    _contestId: BigInt,
  ): ethereum.CallResult<ContestOracleResolved__getContestResultValue0Struct> {
    let result = super.tryCall(
      "getContest",
      "getContest(uint256):((uint32,uint32,address,bytes32,uint8,string,string,string))",
      [ethereum.Value.fromUnsignedBigInt(_contestId)],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<ContestOracleResolved__getContestResultValue0Struct>(
        value[0].toTuple(),
      ),
    );
  }
...
export class CreateContestCall__Inputs {
  ...
  get _scoreContestSourceHash(): Bytes {
...
export class UpdateCreateContestSourceHashCall extends ethereum.Call {
  get inputs(): UpdateCreateContestSourceHashCall__Inputs {
    return new UpdateCreateContestSourceHashCall__Inputs(this);
  }

  get outputs(): UpdateCreateContestSourceHashCall__Outputs {
    return new UpdateCreateContestSourceHashCall__Outputs(this);
  }
}

export class UpdateCreateContestSourceHashCall__Inputs {
  _call: UpdateCreateContestSourceHashCall;

  constructor(call: UpdateCreateContestSourceHashCall) {
    this._call = call;
  }

  get newCreateContestSourceHash(): Bytes {
    return this._call.inputValues[0].value.toBytes();
  }
}

export class UpdateCreateContestSourceHashCall__Outputs {
  _call: UpdateCreateContestSourceHashCall;
